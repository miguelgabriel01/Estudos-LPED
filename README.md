...
Os principais temas estudados neste repositório são:

- Algoritmos  
- Tipos, Operadores e Variáveis  
...
Todos os exemplos e exercícios são apresentados em **JavaScript**, uma linguagem moderna, popular e versátil.
...
- Consolidar e compartilhar conhecimentos sobre lógica de programação e estruturas de dados.  
- Servir como material de estudo e consulta para mim e para outros desenvolvedores.  
- Produzir anotações, exercícios resolvidos e desafios práticos para fixação.  
- Manter uma rotina de estudo constante e progressiva.  
...
- **JavaScript (ES6+)**  
- **Node.js** (para execução dos scripts quando necessário)  
...
Repositório em constante atualização com novos tópicos e exercícios.
